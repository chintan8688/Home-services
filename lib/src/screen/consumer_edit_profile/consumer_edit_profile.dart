...
class ConsumerEditProfile extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return ConsumerEditProfileState();
  }
}

class ConsumerEditProfileState extends State<ConsumerEditProfile> {
  ...
  saveProfile() {
    if (formKey.currentState.validate()) {
      ...
      UserApiProvider.updateProfileConsumer(
        ...
        if (value['result']) {
          setUser(json.encode(value['consumer']));
  ...
  changePassword() {
    if (pformKey.currentState.validate()) {
      ...
      UserApiProvider.changePasswordConsumer(passwordController.text.trim())
          .then((value) {
        setState(() {
          isLoading = false;
        });
