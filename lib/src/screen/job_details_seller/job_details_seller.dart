...
class JobDetailsSeller extends StatefulWidget {
  final job;

  JobDetailsSeller({this.job});

  @override
  State<StatefulWidget> createState() {
    return JobDetailsSellerState();
  }
}

class JobDetailsSellerState extends State<JobDetailsSeller> with RouteAware {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                        padding: EdgeInsets.only(top: size.width * 0.025),
                        child: Text("Package:", style: textTheme.subtitle1)),
                    Padding(
                        padding: EdgeInsets.only(top: size.width * 0.009),
                        child: RichText(
                          text: TextSpan(children: [
                            TextSpan(
                                text: "JMD${job['package_price']}",
                                style: textTheme.caption.copyWith(
